...
import { createCardInstance, createToken, newGame, uid } from '@/lib/game/utils';
...
export function GameClient() {
 ...
 return <main className="mx-auto min-h-screen max-w-3xl px-4 pt-3">
  ...
  <div className="my-3"><GameLog entries={game.log}/></div>
