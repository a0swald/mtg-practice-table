...
export default function HomePage() {
  ...
  return <main className="mx-auto flex min-h-screen max-w-lg flex-col justify-center px-5 py-10">
    <div className="mb-8"><p className="mb-2 text-xs font-bold uppercase tracking-[.28em] text-emerald-300">Commander learning companion</p><h1 className="text-4xl font-black tracking-tight">MTG Practice Table</h1><p className="mt-3 text-sm leading-6 text-zinc-400">Play with your physical cards and use the app as a companion, or load an imported Commander deck and play the whole game virtually.</p></div>
